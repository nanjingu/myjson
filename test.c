...
static void test_parse_invalid_unicode_hex(){
    ...
    TEST_ERROR(LEPT_PARSE_INVALID_UNICODE_HEX, "\"\\u12\"");
...
static void tesr_parse_miss_comma_or_square_bracket() {
...
static void test_parse() {
    ...
    tesr_parse_miss_comma_or_square_bracket();
    test_parse_miss_key();
